...
## Project Structure
    ...
    ├── juantstprdwithmodules_1  # Django project configurations
...
1. Clone this repo and `cd juantstprdwithmodules_1`
...
2. Clone this repo and `cd juantstprdwithmodules_1`
