"""
Django settings for juantstprdwithmodules_1 project.
...
ROOT_URLCONF = 'juantstprdwithmodules_1.urls'
...
WSGI_APPLICATION = 'juantstprdwithmodules_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juantstprdwithmodules_1 API",
    "DESCRIPTION": "API documentation for juantstprdwithmodules_1 App",
    "VERSION": "v1",
}
